...
train<-df.dataset1[c('occupied_cat', dataset1Variables)]
...
iris_norm <- as.data.frame(lapply(iris[,2:ncol(iris)], nor))
...
iris_target_category <- iris[ran,1]
##extract 5th column if test dataset to measure the accuracy
iris_test_category <- iris[-ran,1]
